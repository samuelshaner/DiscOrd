			...
			for y in range(cw):
				for x in range(cw):
					...
					for angle in range(na/4):
						...
						cell.ang_flux[angle] = (source + 2 * self.quad['mu'][angle]/self.mesh_size * self.ang_flux[0, y, angle] + 2 * self.quad['eta'][angle]/self.mesh_size * self.ang_flux[1, x, angle]) / (cell.material.sigma_t + 2 * self.quad['mu'][angle]/self.mesh_size + 2 * self.quad['eta'][angle]/self.mesh_size)
			...
			for y in reversed(range(cw)):
				for x in reversed(range(cw)):
					...
					for angle in range(na/4):	
						...
						# compute cell centered flux
						cell.ang_flux[na/2 + angle] = (source + 2 * self.quad['mu'][angle]/self.mesh_size * self.ang_flux[2, y, angle + na/4] + 2 * self.quad['eta'][angle]/self.mesh_size * self.ang_flux[3, x, angle + na/4]) / (cell.material.sigma_t + 2 * self.quad['mu'][angle]/self.mesh_size + 2 * self.quad['eta'][angle]/self.mesh_size)
			...
			for y in range(cw):
				for x in reversed(range(cw)):
					...
					for angle in range(na/4):	
						...
						# compute cell centered flux
						cell.ang_flux[na/4 + angle] = (source + 2 * self.quad['mu'][angle]/self.mesh_size * self.ang_flux[2, y, angle] + 2 * self.quad['eta'][angle]/self.mesh_size * self.ang_flux[1, x, angle + na/4]) / (cell.material.sigma_t + 2 * self.quad['mu'][angle]/self.mesh_size + 2 * self.quad['eta'][angle]/self.mesh_size)
			...
			for y in reversed(range(cw)):
				for x in range(cw):
					...
					for angle in range(na/4):										
						...
						# compute cell centered flux
						cell.ang_flux[3*na/4 + angle] = (source + 2 * self.quad['mu'][angle]/self.mesh_size * self.ang_flux[0, y, angle + na/4] + 2 * self.quad['eta'][angle]/self.mesh_size * self.ang_flux[3, x, angle]) / (cell.material.sigma_t + 2 * self.quad['mu'][angle]/self.mesh_size + 2 * self.quad['eta'][angle]/self.mesh_size)
